...
<!-- Cita caminhos do regime VLAEG 2.0 e regras de produto; sandbox de scraper nao e ai-jail, excluido por D-044. -->
# Contrato operacional da GennomX AI

Relocado de AGENTS.md na adocao do AI Ready First 4.0.0. O nucleo residente passou a ser o roteador; este arquivo guarda a premissa, o escopo e as regras de produto.
...
Antes de qualquer alteração, ler nesta ordem: `AGENTS.md`, `docs/legacy/project_state-vlaeg2/CONTEXT.md`, `docs/legacy/project_state-vlaeg2/TASKS.md`, o plano ativo citado no contexto, `project_state/DECISIONS.md` e `project_state/FINDINGS.md`.
